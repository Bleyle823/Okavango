...
export interface IAxelarGasService extends BaseContract {
  ...
  updateGasInfo: TypedContractMethod<
    [chains: string[], gasUpdates: GasInfoStruct[]],
    [void],
    "nonpayable"
  >;
